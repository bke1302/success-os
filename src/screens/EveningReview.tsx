  ...
  return (
    <div style={{ height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column', background: '#000' }}>
      <div className="shrink-0" style={{ padding: '24px 20px 20px', borderBottom: '1px solid rgba(255,255,255,.09)' }}>
        <p style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: 9, fontWeight: 700, letterSpacing: '2px', color: 'rgba(255,255,255,.35)', textTransform: 'uppercase', marginBottom: 6 }}>
          {new Date().toLocaleDateString('he-IL', { weekday: 'long', day: 'numeric', month: 'long' })}
        </p>
        <h1 style={{ fontFamily: '"Frank Ruhl Libre", Georgia, serif', fontSize: 30, fontWeight: 900, color: '#f2f2f7' }} dir="rtl">סיכום היום</h1>
        <p style={{ fontFamily: 'Heebo, sans-serif', fontSize: 13, color: 'rgba(255,255,255,.35)', marginTop: 4 }} dir="rtl">3 דקות שמשנות הכל.</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto" style={{ padding: '20px 20px 16px' }}>
        ...
        <div className="card mb-2">
          ...
          <div style={{ background: 'rgba(255,55,95,.05)', border: '1px solid rgba(255,55,95,.15)', borderRadius: 10, padding: '14px 16px', marginBottom: 18 }}>
          ...
          <p style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: 9, fontWeight: 700, letterSpacing: '2px', color: 'rgba(255,255,255,.35)', textTransform: 'uppercase', marginBottom: 12 }}>עמדת בה?</p>
        ...
        <div className="card mb-2">
          ...
          <p style={{ fontFamily: 'Heebo, sans-serif', fontSize: 12, color: 'rgba(255,255,255,.35)', marginBottom: 10, lineHeight: 1.5 }} dir="rtl">לא מה קיבלת — מה נתת. ערך, נוכחות, תמיכה, מאמץ.</p>
          ...
          <p style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: 9, color: given.trim().length >= 3 ? 'rgba(255,214,10,.4)' : 'rgba(255,255,255,.18)', textAlign: 'left', marginTop: 6 }}>
        ...
        {/* ── BLOCK 3: Lesson ────────────────────────────────── */}
        <div className="card mb-2">
          <p style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: 9, fontWeight: 700, letterSpacing: '2px', color: 'rgba(255,255,255,.35)', textTransform: 'uppercase', marginBottom: 6 }}>מה למדת היום?</p>
          <p style={{ fontFamily: 'Heebo, sans-serif', fontSize: 12, color: 'rgba(255,255,255,.35)', marginBottom: 10, lineHeight: 1.5 }} dir="rtl">תובנה, שיעור, טעות שלימדה.</p>
        ...
        <div className="card mb-4">
          <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 16 }}>
            <p style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: 9, fontWeight: 700, letterSpacing: '2px', color: 'rgba(255,255,255,.35)', textTransform: 'uppercase' }}>ציון גדילה יומי</p>
            <span style={{ fontFamily: '"Frank Ruhl Libre", Georgia, serif', fontSize: 'clamp(2.5rem, 12vw, 4rem)', fontWeight: 900, lineHeight: 1, color: score >= 7 ? '#FFD60A' : score >= 5 ? '#fff' : 'rgba(255,255,255,.5)', letterSpacing: '-2px' }}>{score}</span>
          </div>
