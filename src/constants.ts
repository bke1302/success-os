...
export const VIDEO_CARDS: VideoCard[] = [
  ...
  },
  {
    id: 'ted-growth',
    emoji: '',
    title: 'כוח ה-Growth Mindset',
    subtitle: 'Carol Dweck — ההבדל בין אנשים שמגיעים לאן שרצו לבין אלו שלא.',
    speaker: 'Carol Dweck · TED',
    duration: '10 דק׳',
  ...
  },
  {
    id: 'sinek',
    emoji: '',
    title: 'Start With Why — למה אתה עושה מה שאתה עושה?',
    subtitle: 'Simon Sinek על מנהיגות, מוטיבציה, ולמה ה-WHY חשוב מה-WHAT.',
  ...
  },
  {
    id: 'goggins',
    emoji: '',
    title: 'David Goggins — No Excuses',
    subtitle: 'על משמעת פנימית, ריצה בלתי אפשרית, ואמת שכואבת.',
    speaker: 'David Goggins',
    duration: '5-10 דק׳',
    searchUrl: 'https://www.youtube.com/results?search_query=david+goggins+no+excuses+motivation',
    category: 'DISCIPLINE',
  },
  {
    id: 'jocko',
  ...
  },
  {
    ...
    subtitle: 'Kobe Bryant על לאהוב את התהליך יותר מהתוצאה.',
    speaker: 'Kobe Bryant',
    duration: '3-5 דק׳',
...
export const IDENTITY_ARCHETYPES = [
  ...
  { emoji: '', label: 'המנהיג',  desc: 'מעורר השראה, מרים אחרים' },
...
export function getCommanderRank(streak: number): { rank: string; emoji: string; color: string } {
  if (streak >= 30) return { rank: 'אלוף',   emoji: '', color: '#FFD60A' }
  if (streak >= 14) return { rank: 'מפקד',   emoji: '', color: '#FFD60A' }
